...
export default function CustomPaginationActionsTable(props) {
    ...
    const [moduleToDelete, setModuleToDelete] = React.useState("");
    ...
    const deleteModule = () => {
        props.deleteModule(moduleToDelete)
        setAlertDelete(false)
    }
    ...
    return (
        <>
            ...
            >
                <DialogTitle className="titleDialog">Supprimer module</DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    <Button className="supprimerBtn" onClick={deleteModule} style={{ backgroundColor: "#B51B10", color: "white" }} >
                        Supprimer
                    </Button>
                </DialogActions>
            </Dialog>
