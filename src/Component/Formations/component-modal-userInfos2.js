                    ...
                    <div className={classes.rootRow}>
                        <div className = "col-lg-12 col-md-12">
                            <div className="row" style={{marginBottom : "10px"}}>
                                <h5 className={classes.h5Title}>Collaborateur</h5>
                            </div>
                            <div className="row">
                                <div className="col-lg-4 col-md-4">   
                                    <div className="input-group mb-3 ">
                                        ...
                                        <div className="input-group-prepend">
                                            <label style={{fontSize : "14px" , minWidth : 200 , backgroundColor : "white"}}  className="input-group-text" >{infos.collaborateur.bu}</label>
                                        </div>                             
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-4">   
                                    <div className="input-group mb-3 ">
                                        ...
                                        <div className="input-group-prepend">
                                            <label style={{fontSize : "14px" , minWidth : 200 , backgroundColor : "white"}}  className="input-group-text" >{infos.collaborateur.nom}</label>
                                        </div>                             
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-4">   
                                    <div className="input-group mb-3 ">
                                        ...
                                        <div className="input-group-prepend">
                                            <label style={{fontSize : "14px" , minWidth : 200  , backgroundColor : "white"}}  className="input-group-text" >{infos.collaborateur.prenom}</label>
                                        </div>                             
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4">   
                                    <div className="input-group mb-3 ">
                                        ...
                                        <div className="input-group-prepend">
                                            <label style={{fontSize : "14px" , minWidth : 200  , backgroundColor : "white"}}  className="input-group-text" >{infos.collaborateur.email}</label>
                                        </div>                             
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-4">   
                                    <div className="input-group mb-3 ">
                                        ...
                                        <div className="input-group-prepend">
                                            <label style={{fontSize : "14px" , minWidth : 200 , backgroundColor : "white"}}  className="input-group-text" >{infos.collaborateur.adresse}</label>
                                        </div>                             
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-4">   
                                    <div className="input-group mb-3 ">
                                        ...
                                        <div className="input-group-prepend">
                                            <label style={{fontSize : "14px" , minWidth : 200  , backgroundColor : "white"}}  className="input-group-text" >{infos.collaborateur.tel}</label>
                                        </div>                             
                                    </div>
                                </div>
