                                        ...
                                        <CardContent>
                                            <div className="row">
                                                ...
                                                <div className="col-lg-5 col-md-5">
                                                    ...
                                                    <label style={{ fontWeight: "bold" }}>Du : </label> <label>{getDate(props.formation.dateDebut)}</label> <br />
                                                    <label style={{ fontWeight: "bold" }}>Au : </label> <label>{getDate(props.formation.dateFin)}</label>
                                                </div>
